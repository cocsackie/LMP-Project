...
aproxl: main.o splines.o points.o aproksymator_legendre.o gaus/libge.a
	$(CC) -o aproxl  main.o splines.o points.o aproksymator_legendre.o -L gaus -l ge
...
aproksymator_legendre.o: makespl.h points.h gaus/piv_ge_solver.h
	$(CC) -I gaus -c aproksymator_legendre.c
...
clean:
	-rm -f *.o aprox aproxl intrp prosta
